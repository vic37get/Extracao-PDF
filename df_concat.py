...
lic_2018_2022 = pd.read_csv('../arquivos/editais_lic_2018_2022.csv',sep=',',encoding='utf-8')
lic_2007_2017 = pd.read_csv('../arquivos/licitacoes_2007_2017.csv',sep=';',encoding='utf-8')
